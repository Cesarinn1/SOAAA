...
public class PropiedadModel {
    ...
    private Integer metro_cuadrados;
    ...
    public PropiedadModel(Long id_propiedad, ClienteModel propietario, TipoPropiedad tipo, String titulo,
            String descripcion, String direccion, String ciudad, String estidadFederativa, Integer codigo_postal,
            String pais, Double latitud, Double longitud, double precio_noche, int capacidad, int num_habitaciones,
            int num_banos, Integer metro_cuadrados, String comodidades, String reglas, EstadoHab estado,
    ...
    public Integer getMetro_cuadrados() {
        return metro_cuadrados;
    }

    public void setMetro_cuadrados(Integer metro_cuadrados) {
        this.metro_cuadrados = metro_cuadrados;
    }
